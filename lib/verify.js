...
exports.verify = function (data) {
	if (data instanceof Array) {
		...
		if (!eventName) {
			...
			return npmReturnMsg(_regParam6, value, msgSuccess, msgFail);
			...
			return npmReturnMsg(_regParam7, value, msgSuccess, msgFail);
			...
			return npmReturnMsg(_regParam8, value, msgSuccess, msgFail);
			...
			return npmReturnMsg(_regParam9, value, msgSuccess, msgFail);
		} else {
			var _result2 = {
				data: false,
				message: '暂无匹配的校验函数'
